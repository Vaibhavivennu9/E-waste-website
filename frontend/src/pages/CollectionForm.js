...
import { Plus, Trash2, MapPin, Calendar, Clock, ArrowLeft } from 'lucide-react';
...
const CollectionForm = () => {
  ...
  const {
    ...
    defaultValues: {
      items: [{ category: '', brand: '', model: '', condition: 'unknown', quantity: 1, description: '', estimatedValue: 0 }],
      preferredDate: '',
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.error(error.response?.data?.message || 'Failed to create collection request');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const addItem = () => {
    append({ category: '', brand: '', model: '', condition: 'unknown', quantity: 1, description: '', estimatedValue: 0 });
  };
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Schedule E-Waste Collection</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          {/* Items Section */}
          <div className="card">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Items to Collect</h2>
